...
This document contains detailed technical information about the AEROS system, including architecture, APIs, setup instructions, and implementation details.
...
**Implementation:** `api/main.py` lines 287-296 (physics_loop) and lines 335-337 (task creation)
...
For the high-level overview and motivation, see [README.md](README.md).
